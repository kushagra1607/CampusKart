  ...
  return (
    ...
    style={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute left-1/4 top-1/4 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute right-1/4 top-1/3 w-72 h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
            ...
            <div className="flex items-center">
              <input
                ...
                className={`h-4 w-4 rounded border-gray-300 ${
                  darkMode ? "bg-gray-700 text-purple-600 focus:ring-purple-500" : "text-blue-600 focus:ring-blue-500"
                }`}
              />
